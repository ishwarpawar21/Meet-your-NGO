...
class Categories extends CI_Controller
{
	...
	public function add()
	{
		if(isset($_POST['add_category']))
		{
			...
			$this->form_validation->set_rules('category_name','Category Name','required|xss_clean|is_unique[tbl_category_master.category_name]');
			if($this->form_validation->run())
			{
				...
				$insrt_arr=array('category_name'=>$category_name,'parent_id'=>'0','category_level'=>$cat_depth,
	...
	public function delete()
	{
		$category_id=base64_decode($this->uri->segment(4));
		$get_level=$this->master_model->getRecords('tbl_category_master',array('category_id'=>$category_id));
		if($get_level[0]['category_level']=='3' || $get_level[0]['category_level']=='0')
		{
