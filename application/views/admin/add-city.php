                ...
                <?php
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-6 controls">
                         ...
                         <input type="text" class="form-control"	name="city_name" id="city_name" placeholder="City name" value="" data-rule-required="true" />
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                        ...
                        <input type="submit" value="Add city" class="btn btn-primary" name="btn_add_city" id="btn_add_city" onclick="return checkCheckBoxes(this.form);">
		         	...
		         	?>
                             ...
                             <tr>
                                ...
                                <?=$cnt?>
                                 ...
                                 <td><?=$row->state;?></td>
                                <td> 
                                	<a href="<?=base_url()?>superadmin/admin/add_field_list?page=edit_city&id=<?=$row->id?>" title="edit">
                                                				<i class="fa  fa-edit"></i>
                                                			</a>
                                                			<a href="<?=base_url()?>superadmin/admin/add_field_list?btn_delete=delete_city&page=add-city&id=<?=$row->id?>" title="delete">
