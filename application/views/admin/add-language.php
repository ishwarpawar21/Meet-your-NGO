...
<div class="page-title">
    ...
    <div style="clear:both !important;">
        ...
        <h1><i class="fa fa-pencil-square"></i>Add Language</h1>
...
<div id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li>
        	...
        	<a href="<?php echo base_url().'superadmin/'; ?>">Add language</a>
    ...
    <div class="col-md-12">
              ...
              <form class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-6 controls">
                         ...
                         <input type="text" class="form-control"	name="language_name" id="language_name" placeholder="language" value="" data-rule-required="true" />
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                        ...
                        <input type="submit" value="Add" class="btn btn-primary" name="btn_add_language" id="btn_add_language" onclick="return checkCheckBoxes(this.form);">
        ...
        <div class="box">
         <?php 
            ...
            <div class="box-title">
                <h3><i class="fa fa-pencil-square"></i> Manage langauge</h3>
                <div class="box-tool">
		         	...
		         	?>
                             ...
                             <tr>
                                ...
                                <?=$cnt?>
                                 ...
                                 <td><?=$row->language;?></td>
                                 <td><a href="<?=base_url()?>superadmin/admin/add_field_list?page=edit-language&id=<?=$row->id?>" title="edit">
                                                				<i class="fa  fa-edit"></i>
                                                			</a>
                                                				<a href="<?=base_url()?>superadmin/admin/add_field_list?btn_delete=delete_language&page=add-language&id=<?=$row->id?>" title="delete">
