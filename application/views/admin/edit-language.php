...
<div class="page-title">
    ...
    <div style="clear:both !important;">
        ...
        <h1><i class="fa fa-pencil-square"></i>Edit language</h1>
...
<div id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li>
        	...
        	<a href="<?php echo base_url().'superadmin/'; ?>">Edit language</a>
               ...
               <input type="hidden" name="edit_id" value="<?=$_GET['id']?>">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9 col-lg-10 controls">
                       <?php 
                        $result=$this->db->query("select * from language_table where id=".$_GET['id'])->row(); ?>

                         <input type="text" class="form-control" name="language_name_update" id="language_name_update" placeholder="Language" value="<?=$result->language?>" data-rule-required="true" />

                         <?php echo form_error('language_name_update'); ?>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                        ...
                        <input type="submit" value="Update" class="btn btn-primary" name="btn_update_language" id="btn_update_language" onclick="return checkCheckBoxes(this.form);">
