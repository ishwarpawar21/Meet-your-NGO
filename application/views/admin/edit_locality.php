...
<div class="page-title">
    ...
    <div style="clear:both !important;">
        ...
        <h1><i class="fa fa-pencil-square"></i>Edit locality</h1>
...
<div id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li>
        	...
        	<a href="<?php echo base_url().'superadmin/'; ?>">Edit locality</a>
    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-title">
                ...
                <h3><i class="fa fa-bars"></i>Edit locality</h3>
               ...
               <input type="hidden" name="edit_id" value="<?=$_GET['id']?>">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9 col-lg-10 controls">
                       <?php 
                        $result=$this->db->query("select * from locatity_table where id=".$_GET['id'])->row(); ?>

                         <input type="text" class="form-control" name="locality_update" id="locality_update" placeholder="locality" value="<?=$result->locatity_name?>" data-rule-required="true" />

                         <?php echo form_error('locality_update'); ?>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                        ...
                        <input type="submit" value="Update" class="btn btn-primary" name="btn_update_locality" id="btn_update_locality" onclick="return checkCheckBoxes(this.form);">
