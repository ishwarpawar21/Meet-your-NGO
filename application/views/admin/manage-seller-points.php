						   ...
						   ?>
                             <tr>
							    ...
							    $getsum=$this->master_model->getRecords('tbl_userscored_point',array('login_id'=>$sell));
								 ...
								 ?>
                                  <a href="<?php echo base_url().'superadmin/seller/points/fb_share/'.$sell.'/' ?>"><?php echo $getsum[0]['share_point']; ?></a>
                                 </td>
                                <td><?php  
							    ...
							    ?>
                                <a href="<?php echo base_url().'superadmin/seller/points/like/'.$sell.'/' ?>"><?php echo $getsum[0]['like_point']; ?></a> 
                                </td>
                                <td><?php 
							   ...
							   // echo $getsum[0]['comment_point'];
								?>
                                 <a href="<?php echo base_url().'superadmin/seller/points/comment/'.$sell.'/' ?>"><?php echo $getsum[0]['comment_point']; ?></a> 
                                </td>
                                <td>
								<?php 
								...
								?>
                             <!--<a href="<?php echo base_url().'superadmin/seller/points/community/'.$sell.'/' ?>"></a>-->
