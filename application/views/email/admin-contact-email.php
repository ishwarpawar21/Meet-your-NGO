                ...
                <td align="left" valign="top"><table width="630" border="0" align="center" cellpadding="0" cellspacing="0" style="box-shadow: 0 2px 3px #ccc;border-radius:4px;background-color:#ffffff;">
                    <tr>
                      <td align="center" valign="top"><table width="586" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
        	                <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:#525252; padding-bottom:12px; border-bottom:1px dashed #ccc; ">Dear Admin,
                           <br /><br /> Following new contact inquirey has been added on <?php echo date('d / M /Y'); ?>
                             </td>
      	                 </tr>  
                          <tr>
                            ...
                            Fullname : <?php echo ucfirst($first_name); ?>
                                       <?php echo ucfirst($last_name); ?>
                            </td>
      	                </tr>
                          <tr>
        	                <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:#525252; padding-bottom:12px; ">Email : <?php echo $email_id; ?> </td>
      	                </tr>
                          <tr>
        	                <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:#525252; padding-bottom:12px;">Contact : <?php echo $mobile_no; ?>
                           </td>
      	                </tr>
                          <tr>
        	                <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:#525252; padding-bottom:12px; border-bottom:1px dashed #ccc; ">Message : <?php echo ucfirst($message_txt); ?></td>
      	                </tr>
                          <tr>
        	                <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:#525252; padding-bottom:12px; border-bottom:1px dashed #ccc; ">Please contact as soon as possible.</td>
      	                </tr>
                          <tr>
