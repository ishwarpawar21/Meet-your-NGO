    ...
    <td align="center" valign="top" style="background-color:#fff;box-shadow: 0 2px 3px #ccc;"><table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="64" align="left" valign="top"><table width="630" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="450" height="70" valign="middle"><a href="#"><img src="<?php echo base_url(); ?>images/coupon-logo.jpg" alt="logo-coupon" width="184" height="58" border="0" style=" margin-top:5px; margin-bottom:5px;"/></a></td>
                <td width="180" height="64" style="height:40px;line-height:40px;font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold; text-align:right; color:#333;"><?php echo date('l, d M Y'); ?></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
                ...
                <td align="left" valign="top"><table width="630" border="0" align="center" cellpadding="0" cellspacing="0" style="box-shadow: 0 2px 3px #ccc;border-radius:4px;background-color:#ffffff;">
                    <tr>
                      <td align="center" valign="top"><table width="586" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td align="left" style="font-family: Tahoma, Geneva, sans-serif; font-size:13px; font-weight:bold; color:#525252; padding-bottom:10px;">Hello admin, </td>
                          </tr>
                          <tr>
                            <td height="60" align="left" valign="middle" style="font-family: Tahoma, Geneva, sans-serif; font-size:16px;color:#525252; line-height:18px; padding-bottom:10px;">To change your password, Please <a href="<?php echo base_url('superadmin/admin/changepassword/'); ?>" target="_new">Click Here</a></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="90%" style="font-family: Tahoma, Geneva, sans-serif; font-size:13px; font-weight: normal; color:#525252; padding-bottom:10px; text-align:left;">coupon.com &copy;  All Rights Reserved.</td>
                              <!--    <td width="5%" align="right"><a href="#"><img src="<?php echo base_url(); ?>img/email/facebook.png" alt="facebook" width="20" height="20" border="0" /></a></td>
                                  <td width="5%" align="right"><a href="#"><img src="<?php echo base_url(); ?>img/email/twitter.png" alt="twitter" width="20" height="20" border="0" /></a></td>-->
                                </tr>
                              </table></td>
                          </tr>
                          <tr>
