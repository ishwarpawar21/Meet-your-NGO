    ...
    <table width="630" border="0" align="center" cellpadding="0" cellspacing="0" style=" margin-bottom:20px;">
        ...
        <tr>
          <td><table width="630" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #c72a25;">
                      ...
                      <td align="center" valign="top" style="border:1px solid #c72a25;"><table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="center" valign="top" style="padding-top:10px; padding-bottom:10px;line-height:20px;font-family:Arial, Helvetica, sans-serif; font-size:13px;text-align:center; color:#fff;background-color:#c72a25;">You have received this email because you have subscribed to the Coupon newsletter.<br />
                              If you cannot read this email, you can view the <a href="#" class="link-menu">Online Version</a><br />
                              To be sure to receive our Emails, please add <a href="#" class="link-menu">info@coupon.com</a> to your address book.</td>
                        </tr>
                        <tr>
              ...
              <tr>
                <td width="450" height="64"><a href="#"><img src="<?php echo base_url(); ?>images/coupon-logo.jpg" alt="img" width="180" height="62" border="0" style=" margin-left:10px; margin-bottom:4px;"/></a></td>
              ...
              <tr>
                <td height="28" colspan="2" style="height:30px; line-height:30px; padding-right:10px; text-align:right;font-size:14px;border-bottom:1px solid #e0e0e0; border-top:1px solid #e0e0e0; background-color:#FFF;"><a href="#" class="link-menu2"></a></td>
                </tr>
                                  </table></td>
                                </tr>
                                <tr>
                                  <td align="center" valign="top"> <table width="576" border="0" align="center" cellpadding="0" cellspacing="0" style=" background-color:#FFF;">
                                    ...
                                    <tr>
                                      <td height="28" align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:#525252;"><?php echo $news_title; ?>, </td>
                                    </tr>
                                    <tr>
                                      <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;color:#525252; text-align:justify;"><?php echo $news_discription;?>. </td>
                                      </tr>
                                    <tr>
                        ...
                        <tr>
                          <td align="center" valign="top" style="padding-top:10px; padding-bottom:10px;line-height:20px;font-family:Arial, Helvetica, sans-serif; font-size:13px;text-align:center; color:#fff;background-color:#c72a25;">You can <a href="#"  class="link-menu">unsubscribe</a> from this newsletter at any time.<br />
                                        We respect your personal information and we will not share them with any other parties.<br />
                                        For further details, please review our <a href="#"  class="link-menu">terms and conditions</a>.</td>
                        </tr>
                      </table></td>
                    </tr>
                    <tr>
