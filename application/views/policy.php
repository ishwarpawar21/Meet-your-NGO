...
?>
					 <?php 
                         $result=$this->db->query("select front_page_description from tbl_front_page where front_page_name='Privacy policy'")->row();
			               if($result)
		                   { ?>
					 
				 	    <div class="col-md-12"><h4 style="background: #ffcc33;color: #fff">Privacy policy </h4></div>
