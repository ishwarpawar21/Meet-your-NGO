...
<div class="contain"> 
  ...
  <div class="innar-page"> 
    ...
    <div class="co-pages">
      <div class="new-heading-inner">
              ...
              <div class="new-heading-main-head-left">Add Brand</div>
  ...
  <?php if($error_brand!=''){?><div class="err-message" ><?php echo $error_brand; ?></div> <?php } ?>
    
    <div class="co-pages">
    <form method="post"  id="form_add_brand" name="form_add_brand" enctype="multipart/form-data">
    <div class="about-left">
        <div class="about-form"> 
          ...
          <div class="about-fildset" >
            ...
            <div class="about-fild">
      <input type="text" class="form-control"  name="brand_title" id="brand_title" placeholder="Brand Tilte" value="<?php echo set_value('brand_title');?>" style="width:358px" />
          ...
          <div class="about-fildset">
            ...
            <div class="about-fild"><textarea name="brand_desc" id="brand_desc" class="texarea-select" cols="" rows=""><?php echo set_value('brand_desc');?></textarea>
          ...
          <div class="form-group">
                     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-4">
                        <input type="submit" value="Add" class="submit-button" name="btn_add_brand" id="btn_add_brand" lang="add">
