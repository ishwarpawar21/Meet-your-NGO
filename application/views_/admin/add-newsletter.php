...
<div class="page-title">
    <div style="clear:both !important;">
        <h1><i class="fa fa-pencil-square"></i>Add Newsletter</h1>
...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i>Add Newsletter</h3>
                <div class="box-tool">
              ...
              <form class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9 col-lg-10 controls">
                         <input type="text" class="form-control" name="newsletter_subject" id="newsletter_subject" placeholder="Subject" value="" data-rule-required="true" />
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9 col-lg-10 controls">
                         <input type="text" class="form-control" name="news_title" id="news_title" placeholder="News Tilte" value="" data-rule-required="true" />
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 col-lg-2 control-label">Description</label>
                     <div class="col-sm-9 col-lg-10 controls">
                     <textarea class="form-control col-md-12 ckeditor" name="news_description"  id="news_description" rows="6" data-rule-required="true"></textarea>
                  ...
                  <div class="form-group">
                     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                        <input type="submit" value="Submit" class="btn btn-primary" name="btn_add_newsletter" id="btn_add_newsletter">
