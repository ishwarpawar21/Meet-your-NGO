...
if($this->session->userdata('admin_id')=='')
{
 ...
 /*$curr_date=date("H:i:s");
$diff = abs(strtotime($last_time) - strtotime($curr_date));*/
...
<html>
    <head>
        ...
        <title>Coupon | <?php echo $pagetitle; ?></title>
            ...
            <ul class="nav flaty-nav pull-right">
                ...
                <li class="hidden-xs">
                    ...
                    <ul class="dropdown-navbar dropdown-menu header_contact_inq" >
                        ...
                        <!--<li class="notify">
                            <a href="<?php echo base_url() ;?>superadmin/merchant/pendingApproval/">
                        ...
                        <li class="notify">
                            <a href="<?php echo base_url() ; ?>superadmin/transection/userTransection/">
                ...
                <li class="hidden-xs" >
                   ...
                   <?php /*?> <?php for($i=0; $i < count($contactinqcont) ; $i++)
					{ ?>
                    
                        <li class="msg">
                            <a href="<?php echo base_url() ;?>superadmin/frontpages/contactenquirydetails/<?php echo $contactinqcont[$i]['con_id'];?>">
                               <!-- <img src="<?php echo base_url(); ?>img/demo/avatar/avatar3.jpg" alt="Sarah's Avatar" />-->
                                <div>
                                    <span class="msg-title"><?php echo ucfirst($contactinqcont[$i]['con_first_name']) ; ?></span>
                                    <span class="msg-time">
                                        <i class="fa fa-clock-o"></i>
                                        <span><?php echo  date('d-m-Y',strtotime($contactinqcont[$i]['added_date'])) ;?></span>
                                    </span>
                                </div>
                                <p><?php echo substr($contactinqcont[$i]['cont_message'],0,100); ?></p>
                            </a>
                        </li>
					<?php } ?><?php */?>
