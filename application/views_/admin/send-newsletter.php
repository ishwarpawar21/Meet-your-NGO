...
<!-- END Breadcrumb --> 
<!-- BEGIN Main Content -->
<form name="frm-send-newsletter" id="frm-send-newsletter" action="<?php echo base_url().'superadmin/newsletter/send/'; ?>"  method="post">
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        <div class="box-title">
        ...
        <div class="box-content">
          ...
          <div class="table-responsive" style="border:0">
            ...
            <label class="col-sm-1 control-label" style="text-align:right; margin-top:5px">Title</label>
          ...
          <input type="submit"  name="btn_send_newsletter" id="btn_send_newsletter" value="Send" class="btn btn-primary" onclick="javascript : return sendmultiplenewsletter()"/>
            ...
            <table class="table table-advance" <?php if(count($fetch_subscriber)>0){?> id="table1" <?php } ?>>
              ...
              <tbody>
				...
				?>
                <tr>
                  <?php if($rowsub['sub_status']=='1'){ ?>
                  <td style="width:18px"><input type="checkbox" name="check_email[]" id="check_email" value="<?php echo $rowsub['sub_id']; ?>"/></td>
				  <?php }else{?>
                  <td></td>
				  <?php }?>
                  <td><?php echo $rowsub['sub_email']; ?></td>
                  <?php /*?><td><a href="<?php echo base_url().'superadmin/admin/deletenews/'.$rowsub['sub_id'];?>" onclick="javascript : return deletconfirm();"><i class="fa fa-trash-o"></i></a></td><?php */?>
                </tr>
                <?php 
				   }
				}
