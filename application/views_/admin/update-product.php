...
<div class="page-title">
    <div style="clear:both !important;">
        <h1><i class="fa fa-pencil-square"></i>Update Product</h1>
              ...
              <form class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-sm-9 col-md-10 controls">
                         <div class="fileupload fileupload-new" data-provides="fileupload">
                            <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                               <img src="<?php echo base_url().'uploads/product_image/'.$fetch_product[0]['product_image']; ?>" alt="" />
                            </div>
                            ...
                            <div>
                               ...
                               <input type="hidden" class="default" name="old_image" id="old_image" value="<?php echo $fetch_product[0]['product_image'] ;?>"/>
                               </span>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9 col-lg-10 controls">
                         <input type="text" class="form-control" name="product_title" id="product_title" placeholder="Product Tilte" value="<?php echo $fetch_product[0]['product_title']; ?>" />
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 col-lg-2 control-label">Description</label>
                     <div class="col-sm-9 col-lg-10 controls"><textarea id="product_desc" class="form-control col-md-12 ckeditor" data-rule-required="true"  name="product_desc"><?php echo $fetch_product[0]['product_desc']; ?></textarea>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-9 col-lg-10 controls">
                     <input type="text" class="form-control" name="product_point" id="product_point" placeholder="Product Point" value="<?php echo $fetch_product[0]['product_point']; ?>" />
                  ...
                  <div class="form-group">
                     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                        <input type="submit" value="Update" class="btn btn-primary" name="btn_update_product" id="btn_update_product" lang="edit">
                     </div>
                   </div>
               </form>
            </div>
