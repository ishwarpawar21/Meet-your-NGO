      ...
      <div class="my-profile-left">
        <div class="active-inner">
          <div class="new-heading">
            <div class="new-heading-inner">
              ...
              <div class="new-heading-main-head-left">Active Deal's</div>
              <div class="new-heading-main-head-right"><!--There are currently <span><?php //echo count($fetchalldeal);?></span> active Deal--></div>
              <div class="clr"></div>
            </div>
          </div>
          <div class="clr"></div>
        ...
        <div class="active-inner">
          <div class="co-pages" style=" padding-bottom:0px;">
            <?php
		   if(count($fetch_all_deal)>0)
		   {
			    $couponArray = array();
			foreach($fetch_all_deal as $rowcoupon)
			{
            ...
            <div class="product-outre">
              ...
              <div class="product-right">
                <div class="product-right-innet-left">
                  <div class="product-titme"> <a href="<?php echo  $rowcoupon['product_details_url']; ?>" target="_blank"> <?php echo $rowcoupon['coupon_id']; 
                ...
                <div class="product-right-innet-top"> 
                  ...
                  <div class="success-inner">
                    ...
                    <div class="success-100pur"><?php echo $new_pos; ?>
                      <?php //echo $rowcoupon['product_price']; ?>
                    </div>
                    <div class="clr"></div>
                  </div>
                  </a>
                  ...
                  <div class="product-inner-price">
                    ...
                    <div class="product-code-left" style=" padding-right:0px;">
                      <div class="product-dollar"><?php echo $rowcoupon['product_price']; ?></div>
                    </div>
                    <div class="clr"></div>
                  </div>
                </div>
				...
				{?>
                    ...
                    <div class="product-save-in alreadydone" style="display:block;" id="coupon_<?php echo $rowcoupon['coupon_id'];?>" >
                      <div class="product-like-out" > <i class="fa fa-star" style=" margin-top:6px; margin-left:4px; " title="Favourite Coupon" ></i> </div>
                      <div class="clr"></div>
                    </div>
                    </a>
                    <?php 
			    ...
			    ?>
                    ...
                    <div class="product-like-in">
                      <div class="product-like-out"> <img src="<?php echo base_url();?>images/like.png" width="17" height="24" alt="like" style=" margin-top:2px;"/> </div>
                    ...
                    </a> <a href="#" class="like_unlike" id="like_unlike" lang="<?php echo base64_encode(0);?>" rel="<?php echo $rowcoupon['coupon_id'];?>" title="Unlike Coupon" >
                    <div class="product-unlike-in">
                      <div class="product-like-out" > <img src="<?php echo base_url();?>images/unlike.png" width="17" height="24" alt="like" style=" margin-top:2px;"/> </div>
                      <div class="product-like-out" id="unlike<?php echo $rowcoupon['coupon_id'];  ?>">
                        <?php  echo $like_count=$this->master_model->getRecordCount('tbl_like_unlike_master',array('coup_id'=>$rowcoupon['coupon_id'],'unlike_id'=>'1'));?>
                      </div>
                  ...
                  <?php 
					...
					{?>
                  <div class="comment-box-inner" style="width:160px; float:right;" id="loadlikeunlikediv"> <a href="#fade" class="initialism fade_open" >
                    <div class="product-save-in">
                      <div class="product-like-out" > <i class="fa fa-star" style=" margin-top:6px; margin-left:4px;" title="Favourite Coupon"></i> </div>
                      <div class="clr"></div>
                    </div>
                    </a> <a href="#fade" class="initialism fade_open" title="Like Coupon">
                    <div class="product-like-in">
                      <div class="product-like-out"> <img src="<?php echo base_url();?>images/like.png" width="17" height="24" alt="like" style=" margin-top:2px;"/> </div>
                      <div class="product-like-out loadlikediv" id="like<?php echo $rowcoupon['coupon_id'];  ?>">
                        <?php  echo $like_count=$this->master_model->getRecordCount('tbl_like_unlike_master',array('coup_id'=>$rowcoupon['coupon_id'],'like_id'=>'1'));?>
                    ...
                    <input type="hidden" id="txt_like<?php echo $rowcoupon['coupon_id'];?>" value="<?php echo $like_count ?>" />
                    </a> <a href="#fade" class="initialism fade_open" title="Unlike Coupon">
                    <div class="product-unlike-in">
                      <div class="product-like-out" > <img src="<?php echo base_url();?>images/unlike.png" width="17" height="24" alt="like" style=" margin-top:2px;"/> </div>
                      <div class="product-like-out" id="unlike<?php echo $rowcoupon['coupon_id'];  ?>">
                        <?php  echo $like_count=$this->master_model->getRecordCount('tbl_like_unlike_master',array('coup_id'=>$rowcoupon['coupon_id'],'unlike_id'=>'1'));?>
            ...
            <div class="job-pagging">
              <div class="paginate paginate-dark"> <?php echo $links; ?></div>
            </div>
            <?php }else{?>
...
<div id="fade" class="well">
  <div class="top-close-area">
    ...
    <div class="top-close-right">
      <button class="fade_close button-close "></button>
    </div>
    <div class="clr"></div>
  </div>
