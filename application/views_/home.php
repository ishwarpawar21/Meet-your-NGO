...
$fetch_brand=$this->master_model->getRecords('tbl_brand_master',array('brand_status'=>'1'));
?>
<div class="contain"> 
  <!--inner-->
       ...
       <div id="container">
        <div id="carousel">
		   ...
		   if(count($fetch_brand)>0)
           {
             ...
             { 
            ?> 
              <a href="<?php echo base_url();?>brand/<?php echo $brand['brand_slug'];?>"><img src="<?php echo base_url().'uploads/brand/thumb/'.$brand['brand_image']; ?>" alt="partner_1" height="87" width="161" /></a> 
           <?php 
             }
           } 
           ?> 
	     </div>
         <a href="#" id="ui-carousel-next"></a> <a href="#" id="ui-carousel-prev"></a></div>
        <div class="clr"></div>
      </div>
    </div>
  </div>
      ...
      <div class="contain-left">
        ...
        <div class="co-pages">
            ...
            <div class="new-heading-new1">
                ...
                <nav>
       			<ul>
        <li style=" margin-right:5px;"><a href="#" style="padding:7px 15px; font-size:13px; border-radius:3px 3px 0px 0px;border-top:1px solid #ccc;border-right:1px solid #ccc;border-left:1px solid #ccc;" <?php if($this->uri->segment(2)=='higher-lower-price' || $this->uri->segment(2)=='lower-higher-price'){echo 'class="current"';} ?>>Price <i class="fa fa-caret-down"></i></a>
        <!-- First Tier Drop Down -->
          <ul>
            <li><a href="<?php echo base_url().'filter/higher-lower-price/'; ?>">Higher to Lower</a></li>
            <li><a href="<?php echo base_url().'filter/lower-higher-price/'; ?>">Lower  to Higher</a></li>
          </ul>       
        </li>
        <li style=" margin-right:5px;"><a href="#" style="padding:7px 15px; font-size:13px; border-radius:3px 3px 0px 0px;border-top:1px solid #ccc;border-right:1px solid #ccc;border-left:1px solid #ccc;"  <?php if($this->uri->segment(2)=='higher-lower-review' || $this->uri->segment(2)=='lower-higher-review'){echo 'class="current"';} ?>>Review <i class="fa fa-caret-down"></i></a>
        <!--First Tier Drop Down-->
         <ul>
           <li><a href="<?php echo base_url().'filter/higher-lower-review/'; ?>">Higher to Lower</a></li>
           <li><a href="<?php echo base_url().'filter/lower-higher-review/'; ?>">Lower  to Higher</a></li>
         </ul>       
        </li>
        <li style=" margin-right:5px;"><a href="#" <?php if($this->uri->segment(2)=='date'){echo 'class="current"';} ?> style="padding:7px 15px; font-size:13px; border-radius:3px 3px 0px 0px;border-top:1px solid #ccc;border-right:1px solid #ccc;border-left:1px solid #ccc;">Expired Day's <i class="fa fa-caret-down"></i></a>
        <!-- First Tier Drop Down -->
        <ul>
            <li><a href="<?php echo base_url(); ?>">All</a></li>
            <li><a href="<?php echo base_url().'filter/date/'.date('Y-m-d').''; ?>">Today</a></li>
            <?php 
			for($i=1;$i<8;$i++){ 
			$datecheck=date("Y-m-d", strtotime("+ ".$i." day"));
			?>
              <li><a href="<?php echo base_url().'filter/date/'.$datecheck; ?>"><?php echo $i; ?> <?php if($i==1){?>Day <?php }else{ echo "Day's"; }?></a></li>
            <?php } ?>
        </ul>   
       </li>
        <li style=" margin-right:5px;"><a href="<?php echo base_url().'filter/hot-coupon/'; ?>" <?php if($this->uri->segment(2)=='hot-coupon'){echo 'class="current"';} ?> style="padding:7px 15px; font-size:13px; border-radius:3px 3px 0px 0px;border-top:1px solid #ccc;border-right:1px solid #ccc;border-left:1px solid #ccc;"> Hot </a>
       </li>
       <li style=" margin-right:5px;"><a href="<?php echo base_url().'filter/latest/'; ?>" <?php if($this->uri->segment(2)=='latest'){echo 'class="current"';} ?> style="padding:7px 15px; font-size:13px; border-radius:3px 3px 0px 0px;border-top:1px solid #ccc;border-right:1px solid #ccc;border-left:1px solid #ccc;"> Latest </a>
        <!--First Tier Drop Down-->
       </li>
    </ul>
				</nav> 
                ...
                <div class="product-right">
                  ...
                  <div class="comment-box">
                    ...
                    <?php include('timer.php');?>
                      ...
                      <?php //echo base_url().'share_coupon/'.base64_encode($rowcoupon['coupon_id']).'/';class="fancybox fancybox.ajax" ?>
