<div class="contain"> 
        ...
        <div class="active-inner">
          <div class="new-heading">
            <div class="new-heading-inner">
              ...
              <div class="new-heading-main-head-left" >Favourite Coupon</div>
  ...
  <?php if($this->session->flashdata('error')){?><div class="err-message" ><?php echo $this->session->flashdata('error'); ?></div> <?php } ?>
		...
		{	 
			...
			?>
            <div class="quali-btm">
               <div class="quali-title-out" style="width:200px; text-align:center;"><?php echo stripslashes(substr(strip_tags($coupon['coupon_title'],'<p>'),0,70)); ?></div>
              <div class="quali-title-out" style="width:120px;text-align:center;"><?php echo $coupon['product_manufacturer'];?></div>
              <div class="quali-title-out" style="width:150px;text-align:center;"><?php echo $coupon['product_price'];?></div>
              <div class="quali-title-out" style="width:200px; text-align:center;">
              <img src="<?php echo $coupon['coupon_image'];?>" height="50" width="50" title=<?php echo "Coupon Image"; ?> /></div>   
              <div class="quali-title-out" style="width:80px; text-align:center; background:none;">
              		<div class="quali-save"><a href="<?php echo base_url().$type.'/coupon-delete/'.$page.'/'.base64_encode($coupon['coupon_save_id']);?>" onclick="javascript : return deletconfirm();"><i class="fa fa-times" style=" margin-top:3px; margin-left:-1px;" title="Delete"></i></a></div>
                	<div class="clr"></div>
              </div>
                <div class="clr"></div>
          </div>
