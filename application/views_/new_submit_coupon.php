<?php
        	...
        	<div class="new-coupon-left">
			   ...
			   <?php } ?>
			       ...
			       <input type="hidden" name="product_price" id="product_price" value="<?php if(isset($items['Items']['Item']['OfferSummary']['LowestNewPrice']['FormattedPrice'])){echo $items['Items']['Item']['OfferSummary']['LowestNewPrice']['FormattedPrice'];}else if(isset($items['Items']['Item']['ItemAttributes']['ListPrice']['FormattedPrice'])){echo $items['Items']['Item']['ItemAttributes']['ListPrice']['FormattedPrice'];}else{if(isset($items['Items']['Item']['OfferSummary']['LowestNewPrice']['FormattedPrice'])){echo $items['Items']['Item']['OfferSummary']['LowestNewPrice']['FormattedPrice'];}else{if(isset($items['Items']['Item']['OfferSummary']['LowestUsedPrice']['FormattedPrice'])){echo $items['Items']['Item']['OfferSummary']['LowestUsedPrice']['FormattedPrice'];}else{echo '$0';}}} 
								?>"/>
                    ...
                    <div class="about-fildset">
                        ...
                        <div class="asin-product-right">
                        	<div class="asin-co-inner">
                        		<div class="asin-title">Amount : <span><?php 
								if(isset($items['Items']['Item']['OfferSummary']['LowestNewPrice']['FormattedPrice']))
								{echo $items['Items']['Item']['OfferSummary']['LowestNewPrice']['FormattedPrice'];}
								else if(isset($items['Items']['Item']['ItemAttributes']['ListPrice']['FormattedPrice']))
								{echo $items['Items']['Item']['ItemAttributes']['ListPrice']['FormattedPrice'];}else
								{if(isset($items['Items']['Item']['OfferSummary']['LowestNewPrice']['FormattedPrice']))
								{echo $items['Items']['Item']['OfferSummary']['LowestNewPrice']['FormattedPrice'];}
								else
								{if(isset($items['Items']['Item']['OfferSummary']['LowestUsedPrice']['FormattedPrice']))
								{echo $items['Items']['Item']['OfferSummary']['LowestUsedPrice']['FormattedPrice'];}else
								{echo '$0';}}} 
								?></span> </div>
							...
							<div class="asin-co-heading">Title </div>
			                <textarea name="coupon_title"  class="select-coupons" id="coupon_title" style="height:auto;"><?php if(isset($items['Items']['Item']['ItemAttributes']['Title'])){echo $items['Items']['Item']['ItemAttributes']['Title'];} ?></textarea>
							  <?php //if(isset($items['Items']['Item']['ItemAttributes']['Title'])){echo $items['Items']['Item']['ItemAttributes']['Title'];}?>
                            </div>
                            </div>
                             <div class="asin-co-heading">Feature </div>
								...
								if(isset($items['Items']['Item']['ItemAttributes']['Feature']))
								{
									...
									{
									?>
									 <textarea name="coupon_desc" id="coupon_desc" class="select-coupons" style="height:auto;" ><?php foreach($items['Items']['Item']['ItemAttributes']['Feature'] as $row){echo $row;}?></textarea>
									<?php 
									}
									else
									{
									?>
									<textarea name="coupon_desc" id="coupon_desc" class="select-coupons" style="height:auto;" ><?php echo $items['Items']['Item']['ItemAttributes']['Feature']; ?></textarea>
									<?php
									}
								}
								else
								{
								?>
                                 <textarea name="coupon_desc" id="coupon_desc" class="select-coupons" style="height:auto;"></textarea>
								<?php
								}
								?>
                               <div style="width:120px;" class="comment-box-inner"><a href="<?php echo $items['Items']['Item']['DetailPageURL']; ?>" target="_new">View Details</a></div>
                          <div class="clr"></div>    
                        </div>
                        <div class="clr"></div>
                    </div>
