...
$link = base_url().'share/details/'.$productCoupon[0]['coupon_id'].'/';
...
$URL="https://www.facebook.com/dialog/feed?app_id=1512439695640622&link=".urlencode($link)."&name=Get ".$new_pos.' on '.$productCoupon[0]['coupon_title']."&picture=".$productCoupon[0]['coupon_image']."&caption=".urlencode($link)."&description=".stripslashes($productCoupon[0]['coupon_desc'])."&redirect_uri=".base_url()."";
?>
<script type="text/javascript">
$(document).ready(function(){
	 $('div.contain').block({ 
		message: '<h1>Sharing......</h1>', 
      ...
      <div class="co-pages">
        <div class="new-heading">
          <div class="new-heading-inner">
            ...
            <div class="new-heading-main-head-left">Sharing Coupon...</div>
            <div class="clr"></div>
          </div>
        </div>
        <div class="clr"></div>
