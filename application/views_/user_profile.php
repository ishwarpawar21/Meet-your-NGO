  ...
  <div class="innar-page"> 
    ...
    <div class="my-profile-outer"> 
      ...
      <div class="my-profile-left">
        <div class="active-inner">
          <div class="new-heading">
            <div class="new-heading-inner">
              <div class="new-heading-main-head-left">My Profile <span>(<a href="<?php echo base_url('user/edit');?>">Edit profile</a>)</span> </div>
              <div class="clr"></div>
            </div>
          </div>
        </div>
          ...
          <div class="new-heading-new">
            <div class="new-heading-new1">
              <div class="com-list-btn" style=" background:none; padding-bottom:11px;">
                 <div class="com-list-all"> <a href="<?php echo base_url().'member/'.$seldetail[0]['user_slug'].'/shared_coupon/';?>" class="current" >Shared Coupon </a></div>
        ...
        <?php   
		if(count($fetchSharedCoupon)>0)
		{  foreach ($fetchSharedCoupon as $allcoupon)  {?>
        ...
        <div class="clr"></div>
         ...
         <?php if(count($fetchSharedCoupon)>5){?>
        ...
        <?php } ?>
             ...
             <div class="active-inner">
          <div class="submit-heading">
            <div class="latest-sub-title">Comments For <?php echo $this->session->userdata('user_slug');?> <span class="title-arow"><img src="<?php echo base_url(); ?>images/title-arow.png" width="20" height="21" alt="arow" /></span></div>
          </div>
        </div>
        <div class="active-inner" >
          <div class="active-box" style="background:none;" >
          <?php
                    ...
                    <div class="comments-outer">
                      ...
                      <div class="comments-title" style="float:right;"><span>&nbsp;
                        <form name="frmCmnt_<?php echo $userCmnt['id'];?>" method="post" style="width:auto !important;">
                              ...
                              <button type="submit" name="btnDelete" class="com-refresh" >delete</button>
                        </form>
                        </span></div>
