		...
		var httpData = function( xhr, type, s ) { // mostly lifted from jq1.4.4
           ...
           if(expResult == null)
           {
            ...
            if(data=='Success')
			{
				  $('#fade').popup('hide');
				  $('#txt_seller').val();
				  var txt_brand=parseInt($('#txt_brand').val())+1;
				  var seller_brand=parseInt($('#txt_seller').val());
				  if(txt_brand >= seller_brand)
				  {
					$('#check_brand').hide();
				    $('#brand_limit').show();
				  }
				  $('#txt_brand').val(txt_brand);
			      $('#brand_title').val('');
				  $('#brand_logo').val(''); 
				  $('#brand_desc').val('');
			}
			if(data=='Already')
			{
				...
				document.getElementById('error_brand_title').innerHTML="Brand name is already exist.";
				setTimeout(function(){
			...
			if(data=='Extension')
			{
				...
				document.getElementById('error_brand_logo').innerHTML="Please enter proper extension";
				setTimeout(function(){
